...
# This version defines the 'storm year' by using the station (North/South) latitude.

# first step was to run GESLA_data_checker_x.Rmd (or the python version)
# This is step #2
