...
etopo_path = (
    "/home/pth/pCloudDrive/SAFETYHERE/WORKSHOP/ESBJERG2/DATA/ETOPO1_Bed_g_gmt4.grd"
)
...
plot_map(
    ...
    lat_min=20,
    lat_max=55,
    filename="map_usa_satellite.png",
    satellite_view=True,
)
plot_map(
    yellow_df,
    ...
    lat_min=35,
    lat_max=70,
    filename="map_europe_satellite.png",
    satellite_view=True,
)
plot_map(
    yellow_df,
    ...
    lat_min=35,
    lat_max=70,
    filename="map_europe2_satellite.png",
    satellite_view=True,
    dot_size_red=20,
    dot_size_yellow=15,
)
...
plot_map(
    ...
    lat_min=32,
    lat_max=48,
    filename="map_japan_satellite.png",
    satellite_view=True,
)
plot_map(
    yellow_df,
...
plot_map(
    ...
    lat_min=-50,
    lat_max=-10,
    filename="map_australia_satellite.png",
    satellite_view=True,
)
