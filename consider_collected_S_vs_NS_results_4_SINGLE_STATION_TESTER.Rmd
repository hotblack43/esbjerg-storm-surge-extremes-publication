---
title: "Considering the results of S vs NS testing on GESLA residuals - v4"
output: 
  pdf_document: 
    fig_height: 7
---
...
# Where are the GESLA files?
#data_dir <- "~/GESLA"  # At home
#data_dir <- "/data/users/pth/GESLA" # at DMI
```

# Clean up the df
```{r}
# The stations named below are REMOVED from further analysis
...
png("~/WORKSHOP/ESBJERG2/PUBLICATION/FIGURES/hist_beta_best.png")
